...
public class EditEntryResponse extends XMPPBean {

	private static final long serialVersionUID = -3659703236037597614L;
	private String entryId = null;

	public EditEntryResponse( String id ) {
		super();
		this.entryId = id;
	...
	public static final String CHILD_ELEMENT = "EditEntryResponse";
	...
	public XMPPBean clone() {
		EditEntryResponse clone = new EditEntryResponse( entryId );
