...
public class ListCreatedInfo extends XMPPBean {
	...
	public static final String CHILD_ELEMENT = "ListCreatedInfo";
	...
	public XMPPBean clone() {
		ListCreatedInfo clone = new ListCreatedInfo( list );
