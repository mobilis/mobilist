...
public class CreateListRequest extends XMPPBean {
	...
	public static final String CHILD_ELEMENT = "CreateListRequest";
	...
	public XMPPBean clone() {
		CreateListRequest clone = new CreateListRequest( list );
